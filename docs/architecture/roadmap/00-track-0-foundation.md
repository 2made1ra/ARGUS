...
- Стек: Python 3.12+, FastAPI, Celery, SQLAlchemy 2.x async, Qdrant.
...
- Если LibreOffice/tesseract нельзя установить из стандартных репозиториев
  python:3.12-slim — остановись и опиши вариант с другим базовым образом
  (например `python:3.12-bookworm`).
